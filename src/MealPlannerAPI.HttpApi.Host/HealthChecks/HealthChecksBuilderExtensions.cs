...
{
    public static void AddMealPlannerAPIHealthChecks(this IServiceCollection services)
    {
        // Add your health checks here
        var healthChecksBuilder = services.AddHealthChecks();
        healthChecksBuilder.AddCheck<MealPlannerAPIDatabaseCheck>("MealPlannerAPI DbContext Check", tags: new string[] { "database" });
